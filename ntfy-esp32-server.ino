...
#define ssid "Galaxy S23 75A3"
#define password "qcomqcom"
String serverName = "https://ntfy.sh/9PD2kcnOUqC7i1Vl48kewn";
...
void setup() {
  ...
  WiFi.begin("Galaxy S23 75A3", "qcomqcom"); 
...
void loop() {
  ...
  if(ledstate == 1){
    digitalWrite(LED_BUILTIN, ONSTATE);
  }else{
    digitalWrite(LED_BUILTIN, OFFSTATE);
  }
}
